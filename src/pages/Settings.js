    ...
    return(
        <div className="px-6 pb-4 max-w-3xl">
            ...
            <table className="w-full">
                <tbody>
                <tr>
                    <td className="pr-6 py-2 font-bold w-1/2">{t('settings.themeName')}</td>
                ...
                <tr>
                    <td className="pr-6 py-2 font-bold">{t('settings.username')}</td>
                    <td className="py-2">
                        <input type="text"
                            className="w-full px-4 py-2 text-black rounded-full"
                            value={userName}
                ...
                <tr>
                    <td className="pr-6 py-2 font-bold">{t('settings.languages')}</td>
                    <td className="py-2">
                ...
                <tr>
                    <td className="pr-6 py-2 font-bold">{t('settings.currentTheme')}</td>
                    <td className="py-2">
                ...
                <tr>
                    <td className="pr-6 py-2 font-bold">{t('settings.changeTheme')}</td>
                    <td className="py-2">
                ...
                <tr>
                    <td className="pr-6 py-2 font-bold">{t('settings.sidebarStatus')}</td>
                    <td className="py-2">
                        <div className="px-4 py-2 border-2 border-primary rounded-full uppercase">
                            {theme.sidebar}
                        </div>
